...
export default defineSchema({
  ...
  }).index("by_company", ["companyId"]).index("by_token", ["token"]).index("by_email", ["email"]).index("by_companyId_and_email_and_status", ["companyId", "email", "status"]).index("by_companyId_and_status", ["companyId", "status"]),
