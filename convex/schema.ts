...
export default defineSchema({
  ...
  jdTaskCompletions: defineTable({ companyId: v.id("companies"), jdTaskId: v.id("jdTasks"), cycleStart: v.number(), cycleEnd: v.optional(v.number()), completedByMembershipId: v.id("companyMemberships"), completedAt: v.number(), note: v.optional(v.string()) }).index("by_task", ["jdTaskId"]).index("by_task_and_cycleStart", ["jdTaskId", "cycleStart"]).index("by_task_and_completedAt", ["jdTaskId", "completedAt"]),
